  ...
  return (
    <div className="mb-12 lg:mb-24 pt-12 border-t border-slate-100">
      <div className="text-center mb-12">
        <h2 className="text-2xl font-black text-slate-900 tracking-tight mb-2">Informações técnicas do lote</h2>
        <p className="text-slate-500 font-medium text-sm tracking-normal">Detalhamento completo para leitura rápida.</p>
      </div>
...
const TechnicalCard = ({ icon, label, value, color }: { icon: React.ReactNode, label: string, value: string | number, color: string }) => (
  <div className="w-full sm:w-[260px] bg-white p-4 sm:p-5 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-all group">
    <div 
    ...
    <div className="text-left">
      ...
      <p className="text-sm font-black text-slate-900 leading-tight break-words">{value}</p>
    </div>
  </div>
);
