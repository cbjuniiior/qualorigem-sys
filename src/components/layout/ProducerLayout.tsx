  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50">
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
        <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-4 border-r border-green-200 shadow-lg">
          {/* Logo */}
          <div className="flex h-16 shrink-0 items-center">
            <Link to="/produtor" className="flex items-center space-x-2">
      ...
      <div className="lg:pl-72">
        {/* Header mobile */}
        <div className="sticky top-0 z-40 flex items-center gap-x-6 bg-white/80 backdrop-blur-md px-4 py-4 shadow-sm sm:px-6 lg:hidden">
          <Button
            variant="ghost"
            size="sm"
